...
const (
	dockerContainerLabelHide        = "luna.hide"
	dockerContainerLabelName        = "luna.name"
	dockerContainerLabelURL         = "luna.url"
	dockerContainerLabelDescription = "luna.description"
	dockerContainerLabelSameTab     = "luna.same-tab"
	dockerContainerLabelIcon        = "luna.icon"
	dockerContainerLabelID          = "luna.id"
	dockerContainerLabelParent      = "luna.parent"
	dockerContainerLabelCategory    = "luna.category"
)
...
func fetchDockerContainersFromSource(
	...
	for i := range containers {
		...
		for label, value := range overrides {
			container.Labels["luna."+label] = value
		}
	}
