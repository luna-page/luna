...
func serveUpdateNoticeIfConfigLocationNotMigrated(configPath string) bool {
	...
	// luna.yml wasn't mounted to begin with or was incorrectly mounted as a directory
	if stat, err := os.Stat("luna.yml"); err != nil || stat.IsDir() {
		return false
	}
	...
	fmt.Println("!!! WARNING !!!")
	fmt.Println("The default location of luna.yml in the Docker image has changed starting from v0.7.0.")
	fmt.Println("Please see https://github.com/luna-page/luna/blob/main/docs/v0.7.0-upgrade.md for more information.")
